...
export const translations = {
  lo: {
    ...
    aboutTitle: "ກ່ຽວກັບ",
    currentPromotion: "✦ ໂປຣໂມຊັນປັດຈຸບັນ",
    ...
    infoText3: "ນີ້ແມ່ນແຜນທີ່ຈຳລອງ. ຂໍ້ມູນຮ້ານ, ໂປຣໂມຊັນ ແລະ ເສັ້ນທາງນຳທາງແມ່ນເພື່ອການສາທິດເທົ່ານັ້ນ.",
    gotIt: "ເຂົ້າໃຈແລ້ວ",
    ...
    defaultPromo: "ຍັງບໍ່ທັນມີໂປຣໂມຊັນເທື່ອ.",
  ...
  en: {
    ...
    infoText3: "This is a demonstration venue. Store information, promotions, and walking routes are illustrative, not live event or emergency guidance.",
    gotIt: "Got it",
    ...
    defaultPromo: "No current promotion listed.",
